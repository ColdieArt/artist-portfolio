        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 mb-24 md:mb-32">
            ...
            <div className="aspect-[3/4] relative overflow-hidden bg-charcoal">
              <div className="w-full h-full flex items-center justify-center border border-white/5">
                <div className="text-center">
                  <div className="w-32 h-32 rounded-full bg-charcoal border border-white/10 mx-auto mb-4 flex items-center justify-center">
                    <span className="font-display text-4xl text-white/20">C</span>
                  </div>
                  <p className="font-mono text-[10px] uppercase tracking-[0.15em] text-steel/40">
                    Artist Photo
                  </p>
                </div>
              </div>
          ...
          <ScrollReveal className="lg:col-span-3" delay={150}>
            <div>
              ...
              <div className="space-y-4 text-steel/80 text-[15px] leading-relaxed">
                <p>
              ...
              <div className="flex items-center gap-4 mt-8">
                <a
                  ...
                  className="flex items-center gap-2 text-steel hover:text-neon-green transition-colors"
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                  </svg>
                  <span className="font-mono text-xs">@Coldie</span>
                </a>
                <a
        ...
        <ScrollReveal>
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-40">
            {['Cointelegraph', 'SuperRare', 'Nifty Gateway'].map((pub) => (
              <span
                key={pub}
                className="font-display text-lg md:text-xl text-steel"
              >
                {pub}
              </span>
            ))}
