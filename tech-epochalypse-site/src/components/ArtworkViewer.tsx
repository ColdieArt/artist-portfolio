  ...
  return (
    <div className="w-full flex flex-col items-start">
      <a
        ...
        className="group relative inline-flex items-center gap-3 px-6 py-3 bg-white text-black font-mono text-sm uppercase tracking-[0.2em] transition-all duration-300 hover:bg-white/90"
      >
