  ...
  return (
    <div className="w-full flex flex-col items-start">
      <a
        ...
        className="group relative inline-flex items-center gap-3 px-6 py-3 border border-white/20 hover:border-white/50 text-white/70 hover:text-white font-mono text-sm uppercase tracking-[0.2em] transition-all duration-300 hover:bg-white/5"
      >
      ...
      <p className="mt-2 font-mono text-[10px] text-white/15 tracking-wider uppercase">
